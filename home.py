...
def cekLogin(username, password):
    with urllib.request.urlopen("http://localhost/database_offline/apioffline.php?auth=888&perintah=loginadmin&username=mitra&password=usaha"+username+"&pass="+password) as json_url:
